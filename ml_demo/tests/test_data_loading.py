...
from ml_demo.data_loaders.load__data import load_data_from_file

class TestDataLoading(unittest.TestCase):

    def test_input_data_forTraining(self) :

        expected_df =  pd.read_csv('./data/customers_data.csv')
        actual_df = load_data_from_file()
